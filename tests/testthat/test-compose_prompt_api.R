...
test_that("compose_prompt_api works on empty args", {
  ...
  # execution
  res_usr_only <- compose_prompt_api(usr_prompt)
  res_sys_only <- compose_prompt_api(sys_prompt)
